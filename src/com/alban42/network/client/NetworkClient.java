...
/**
 * This class provide an easy way to send packet to the server. The
 * {@link NetworkClientListener} is used as the listener of the responses of by
 * the server.
 *
 * @author Alban
 */
public class NetworkClient {
	...
	public void connect(String host, int tcpPort, ClassRegister classRegister, NetworkClientListener listener)
			throws IOException {
		connect(host, tcpPort, tcpPort + 1, classRegister, listener);
	}

	public void connect(String host, int tcpPort, int udpPort, ClassRegister classRegister,
			NetworkClientListener listener) throws IOException {
